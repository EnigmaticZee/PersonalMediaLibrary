    ...
    <div class="wrapper">
        ...
        <form method="post" action="suggest.php">
                ...
                <tr>
                    ...
                    <td>
                        <select name="category" id="category">
                            ...
                            <option value="Books"<?php if(isset($category) && $category == "Books") echo " selected"; ?> >Book(s)</option>
                            <option value="Movies" <?php if(isset($category) && $category == "Movies") echo " selected"; ?>>Movie(s)</option>
                            <option value="Music" <?php if(isset($category) && $category == "Music") echo " selected"; ?>>Music(s)</option>
                        </select>
                    </td>
                </tr>
            ...
            <tr>
                ...
                <tr>
                    <th> <label for="details">Addtional Details</label></th>
